...
function setSlider() {
    ...
    if (active === 0) {
        container.style.backgroundImage = 'radial-gradient(circle, #9b59b6, #8e44ad)';
        ...
        container.style.backgroundImage = 'radial-gradient(circle, #0000ff, #8e44ad)';
